...
c.TerminalInteractiveShell.highlighting_style = 'awesome'

## Override highlighting format for specific tokens
c.TerminalInteractiveShell.highlighting_style_overrides = {
    Token.Prompt: '#ffffff',
    Token.PromptNum: '#50fa7b bold',
    Token.OutPrompt: '#ff6b64',
    Token.OutPromptNum: '#ff5252 bold',
}
